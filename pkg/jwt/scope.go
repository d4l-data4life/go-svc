...
const (
	...
	StudyBIEventCreate               = "biev:c"
	StudyFeedbackCreate              = "fdbck:c"
	StudyUserSettingsCreate          = "sett:c"
	StudyUserSettingsRead            = "sett:r"
	StudyUserSettingsUpdate          = "sett:u"
	StudyUserSettingsDelete          = "sett:d"
	StudyAccountDelete               = "acc:d"
	ContLibBookmarkCreate            = "bkmrk:c"
	ContLibBookmarkRead              = "bkmrk:r"
	ContLibBookmarkDelete            = "bkmrk:d"
	ContLibArticleRatingCreate       = "artrat:c"
	ContLibArticleRatingRead         = "artrat:r"
	ContLibArticleRatingUpdate       = "artrat:u"
	ContLibArticleRatingDelete       = "artrat:d"
	ContLibArticleRecommendationRead = "artrec:r"
	ContLibSubscriptionCreate        = "contsub:c"
	ContLibSubscriptionRead          = "contsub:r"
	ContLibSubscriptionDelete        = "contsub:d"
	StudyConsentSignatureCreate      = "conssign:c"
	StudyConsentSignatureDelete      = "conssign:d"
	StudyConsentCreate               = "cons:c"
	StudyConsentRead                 = "cons:r"
	StudyConsentDelete               = "cons:d"
	StudyConsentRevoke               = "cons:revoke"
	StudyEnrollmentCreate            = "enroll:c"
	StudyEnrollmentRead              = "enroll:r"
	StudyEnrollmentUpdate            = "enroll:u"
	StudyEnrollmentDelete            = "enroll:d"
	StudySkippedStepsCreate          = "skipstep:c"
	StudySkippedStepsRead            = "skipstep:r"
	StudySkippedStepsUpdate          = "skipstep:u"
	StudySkippedStepsDelete          = "skipstep:d"
	StudyTokenCreate                 = "stdytok:c"
	StudyTokenRead                   = "stdytok:r"
	StudyTokenDelete                 = "stdytok:d"
	StudyInvalidTokenAttemptDelete   = "invtokatt:d"
	StudyDebugEmailsTrigger          = "dbgemails:trigger"
	StudySurveySubscriptionCreate    = "survsub:c"
...
var (
	...
	KnownTokens = map[string]struct{}{
		...
		StudyBIEventCreate:               exists,
		StudyFeedbackCreate:              exists,
		StudyUserSettingsCreate:          exists,
		StudyUserSettingsRead:            exists,
		StudyUserSettingsUpdate:          exists,
		StudyUserSettingsDelete:          exists,
		StudyAccountDelete:               exists,
		ContLibBookmarkCreate:            exists,
		ContLibBookmarkRead:              exists,
		ContLibBookmarkDelete:            exists,
		ContLibArticleRatingCreate:       exists,
		ContLibArticleRatingRead:         exists,
		ContLibArticleRatingUpdate:       exists,
		ContLibArticleRatingDelete:       exists,
		ContLibArticleRecommendationRead: exists,
		ContLibSubscriptionCreate:        exists,
		ContLibSubscriptionRead:          exists,
		ContLibSubscriptionDelete:        exists,
		StudyConsentSignatureCreate:      exists,
		StudyConsentSignatureDelete:      exists,
		StudyConsentCreate:               exists,
		StudyConsentRead:                 exists,
		StudyConsentDelete:               exists,
		StudyConsentRevoke:               exists,
		StudyEnrollmentCreate:            exists,
		StudyEnrollmentRead:              exists,
		StudyEnrollmentUpdate:            exists,
		StudyEnrollmentDelete:            exists,
		StudySkippedStepsCreate:          exists,
		StudySkippedStepsRead:            exists,
		StudySkippedStepsUpdate:          exists,
		StudySkippedStepsDelete:          exists,
		StudyTokenCreate:                 exists,
		StudyTokenRead:                   exists,
		StudyTokenDelete:                 exists,
		StudyInvalidTokenAttemptDelete:   exists,
		StudyDebugEmailsTrigger:          exists,
		StudySurveySubscriptionCreate:    exists,
